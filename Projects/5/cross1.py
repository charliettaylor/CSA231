...
def format_grid(grid: list, words: dict) -> list:
    '''
    replace letter with blanks and put hint number in place
    '''
...
def to_txt(grid: list, words: dict) -> None:
    '''
    print generated crossword puzzle to yourpuzzle.txt
    '''
...
def display_grid(grid: list, words: dict) -> None:
    '''
    print generated crossword puzzle to console
    '''
    for line in grid:
        for cell in line:
            print(str(cell) + ' ', end="")
...
if __name__ == "__main__":
    ...
    pprint(grid)
    place_word('hello', Coordinate(0,0), Coordinate(4,0))
    print("\n\n\n")
    pprint(grid)
    words = {}
    to_txt(words)
